  ...
  static async updateSchool(id: string, request: any) {
    ...
    const updatedSchool = await prisma.school.update({
      ...
      data: {
        ...
        schoolType: request.schoolType !== undefined ? request.schoolType : undefined,
        city: request.city !== undefined ? request.city : undefined,
        state: request.state !== undefined ? request.state : undefined,
        country: request.country !== undefined ? request.country : undefined,
